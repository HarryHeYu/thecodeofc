...
void printError(ErrorCode err) {
    switch (err) {
        ...
        case ERR_MEMORY_ALLOCATION: printf("Error: Memory allocation failed.\n"); break;
        case ERR_INVALID_CHARACTER: printf("Error: Invalid character in expression.\n"); break;
        case ERR_INVALID_OPERATOR: printf("Error: Invalid operator in expression.\n"); break;
        case ERR_DIVISION_BY_ZERO: printf("Error: Division by zero.\n"); break;
        case ERR_INVALID_EXPRESSION: printf("Error: Invalid expression.\n"); break;
        case ERR_INVALID_FUNCTION: printf("Error: Invalid function.\n"); break;
